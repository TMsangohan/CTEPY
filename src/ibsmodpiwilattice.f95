...
! ===============================================================================================================
subroutine modPiwLattice(pnumber,epsx,epsy,sigs,dponp,pi,circ,&
clight,qatom,aatom,betar,betx,bety,dispx,dispxp,leng,alfx,nElem,gamma0,alfap0,alfax0,alfay0)
! uses Piwinski's formulae for ibs, pg 126 in handbook
! taking variations of optical functions in lattice into account

integer, intent(in) :: nElem
double precision, dimension(nElem) :: betx,bety,dispx,leng,dispxp,alfx
...
double precision :: a,b,q,fmohlx,fmohly,fmohlp,bx,by,xdisp,dxp,bxp,H
...
! zero out average quantities
      ...
      do i=1,nElem
         ...
         H=(xdisp**2+(bx*dxp-0.5*xdisp*bxp)**2)/bx
...
!included in ibslong no need to reload
!include 'fmohl.f95'
