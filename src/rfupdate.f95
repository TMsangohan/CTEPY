...
!   
!   DESCRIPTION : 
!       SYNCHROTRON MOTION ROUTINE
! ---------------------------------------------------------------------------------------------------------------

! ==============================================================================================================
! np          : number of macro particles in bunch
! fmix        : scaling factor
! nLostDebunch: number of macro particles lost due to debunching
! omega0      : rf omega0
! v00         :
! thib        : bunch height
! tcoeff      : parameter
! nharm1      : harmonic number of first rf system
! nharm2      : harmonic number of second rf system
! vrf1        : voltage rf1
! vrf2        : voltage rf2
! kept        : number of particles that are kept, still in bucket
! ==============================================================================================================
